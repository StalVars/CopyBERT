...
class BertEncoder2Decoder(BertPreTrainedModel):
    ...
    def forward(self, input_ids, output_ids, input_token_type_ids=None, output_token_type_ids=None, input_mask=None, output_mask=None, start_positions=None, end_positions=None,decoder_mask=True,evaluate=False):
