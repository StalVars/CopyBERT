...
class BertForQuestionGeneration(BertPreTrainedModel):
    ...
    def forward(self, input_ids, prediction_ids, token_type_ids=None, attention_mask=None, start_positions=None, end_positions=None,decoder_mask=True,evaluate=False, copymethod=1):
        ...
        if self.iscuda:
          ...
          question_mask = torch.bmm(question_mask_ids, question_mask_ids.transpose(1,2)) * torch.tril(torch.ones(question_mask_ids.size(1),question_mask_ids.size(1))).unsqueeze(0)
