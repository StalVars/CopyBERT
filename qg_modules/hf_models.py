...
from dpr.models.autoencoder import AutoEncoder
from .reader import Reader

logger = logging.getLogger(__name__)

def get_bert_autoencoder_components(cfg, inference_only: bool = False, **kwargs):
    ...
    biencoder = AutoEncoder(question_encoder, ctx_encoder, fix_ctx_encoder=fix_ctx_encoder)
