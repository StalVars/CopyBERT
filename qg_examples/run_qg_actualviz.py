...
from qg_modules.modeling_bert_viz import BertForQuestionGeneration
...
def translate_batch(
        ...
        input_ids, segment_ids, input_mask, start_positions, end_positions, references, bboxes = batch
     ...
     for eval_features in  convert_examples_to_features(
        ...
        with torch.no_grad():
         for input_ids, input_mask, segment_ids, start_positions, end_positions, bboxes, pixel_values, example_indices in tqdm(eval_dataloader, desc="Evaluating", disable=args.local_rank not in [-1, 0]):
            ...
            inputs = [ input_ids, segment_ids,input_mask, start_positions, end_positions, references, bboxes ]
...
def main():
    ...
    print(model_class, args.bert_model)
