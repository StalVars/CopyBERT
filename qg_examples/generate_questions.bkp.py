...
def generate_questions(model, tokenizer, args, device, context="sample context", no_of_datapoints=-1,train=False,qlm_model=None,test_examples=None):
...
def main():
    ...
    generate_q_server=QuestionGenerator(model=model, tokenizer=tokenizer,args=args)
    ...
    while True:
        ...
        generate_questions(model, tokenizer, args,device,qlm_model=qlm_model, context=context)
